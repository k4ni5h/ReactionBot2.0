...
def sadness():
	...
	#clockwise(pwm1,initial_pos,final_pos,mtr_time)	
	clockwise(pwm2,initial_pos,initial_pos-3,mtr_time)
...
def anger():
	...
	anticlockwise(pwm2,initial_pos,initial_pos+5,mtr_time)	# Eyelid motor from 90 to 126 i.e. pwm 8 to pwm 5
...
def fear():
	...
	final_pos=16
	#pwm1.ChangeDutyCycle(0)
	clockwise(pwm2,initial_pos,initial_pos-4,mtr_time)  #initial position at 90 & final position at 111

	pwm2.ChangeDutyCycle(initial_pos-4)
	time.sleep(1)
	pwm2.ChangeDutyCycle(0)
	...
	anticlockwise(pwm2,15,19,mtr_time)
...
def blink():
	...
	final_pos=16
	#pwm1.ChangeDutyCycle(0)
	clockwise(pwm2,initial_pos,initial_pos-3,mtr_time)  #initial position at 90 & final position at 111
